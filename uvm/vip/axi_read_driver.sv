...
class axi_read_driver extends uvm_object;
    ...
    virtual task drive_r_channel();
        ...
        forever begin
            ...
            forever begin
                ...
                tr.ruser[i] = vif.master_cb.ruser;
                rlast_snapshot = vif.master_cb.rlast;
    ...
    local function void flush_mailboxes();
        ...
        `uvm_info(get_type_name(), "RESET detected, read driver queues flushed", UVM_LOW)
    endfunction
